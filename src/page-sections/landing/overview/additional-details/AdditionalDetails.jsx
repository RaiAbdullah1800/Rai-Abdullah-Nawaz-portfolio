...
export default function AdditionalDetails() {
  ...
  return <Card className="p-3">
      ...
      <Stack mt={3} spacing={2}>
        ...
        <ListItem Icon={Education} title="Lab Assistent (PF) Nov 2023 - Mar 2024" email="adeel.ahmed@uog.edu.pk" subTitle="Under the supervision of Adeel Ahmed at University of Gujrat" color={theme.palette.warning.main} />
          <hr />
